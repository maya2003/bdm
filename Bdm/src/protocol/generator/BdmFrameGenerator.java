...
public class BdmFrameGenerator
{
  ...
  protected BdmMethodGenerator m_bdmParseMethodGenerator;
  ...
  public BdmFrameGenerator(BdmProtocolGenerator bdmProtocolGenerator, BdmFrame bdmFrame)
  {
    ...
    m_bdmParseMethodGenerator = new BdmMethodGenerator("void", new StringBuilder()
      .append(bdmProtocolGenerator.getNameUpperCamel())
      .append("_manage")
      .append(getNameUpperCamel())
      .append("Frame").toString());
    m_bdmParseMethodGenerator.addParameter("Bdm_ProtocolContext *", "context");
    if(!m_bdmFrame.fields.isEmpty())
    {
      m_bdmParseMethodGenerator.addParameter(getType() + " *", getName());
    }
...
///// TODO u8 spare;
  ...
  public void appendFrameTypeCase(StringBuilder s)
  {
    ...
    if(!m_bdmFrame.fields.isEmpty())
    {
      m_bdmParseMethodGenerator.appendMethodCall(s, new Parameter[]{new Parameter("context", false), new Parameter("frame", true)});
    }
    else
    {
      m_bdmParseMethodGenerator.appendMethodCall(s, new Parameter[]{new Parameter("context", false)});
    }
    s.append("      break;\n" +
             "    }\n\n");
  }
  ...
  {
    m_bdmParseMethodGenerator.appendMethodDeclaration(s);
  }
  ...
  {
    m_bdmParseMethodGenerator.appendMethodDefinition(s);
    s.append("{\n");
