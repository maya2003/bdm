...
public class BdmField
{
  ...
  public final BdmSetAttribute     m_errorValues;
  public final BdmSetAttribute     m_notAvailableValues;
  public final BdmSetAttribute     m_validValues;
...
//public final BdmStringAttribute  m_realGain;   // special
  ...
  public BdmField() throws BdmException //TODO !!
  {
    ...
    m_errorValues         = new BdmSetAttribute    ("errorValues",         true);
    m_notAvailableValues  = new BdmSetAttribute    ("notAvailableValues",  true);
    m_validValues         = new BdmSetAttribute    ("validValues",         true);
